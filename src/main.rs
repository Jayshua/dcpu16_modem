...
impl Lem1820 {
	...
	fn interrupt(&mut self, dcpu: &mut dcpu::Dcpu) {
	...
	fn render(&mut self, dcpu: &mut dcpu::Dcpu) {
		use glium::Surface;
...
fn main() {
	...
	let mut monitor = Lem1820::new();

	monitor.video_ram = 0x0006;
	dcpu.memory[0x0006] = 0b1111_0000_0100_1000;
	dcpu.memory[0x0007] = 0b1111_0000_0110_0101;
	dcpu.memory[0x0008] = 0b1111_0000_0110_1100;
	dcpu.memory[0x0009] = 0b1111_0000_0110_1100;
	dcpu.memory[0x000a] = 0b1111_0000_0110_1111;
	dcpu.memory[0x000b] = 0b1111_0000_0010_0000;
	dcpu.memory[0x000c] = 0b1111_0000_0100_0010;
	dcpu.memory[0x000d] = 0b1111_0000_0111_0010;
	dcpu.memory[0x000e] = 0b1111_0000_0110_0001;
	dcpu.memory[0x000f] = 0b1111_0000_0111_1000;
	dcpu.memory[0x0010] = 0b1111_0000_0111_0100;
	dcpu.memory[0x0011] = 0b1111_0000_0110_1111;
	dcpu.memory[0x0012] = 0b1111_0000_0110_1110;
	dcpu.memory[0x0013] = 0b1111_0000_0010_0001;

	// Render
	loop {
		monitor.render(&mut dcpu);
